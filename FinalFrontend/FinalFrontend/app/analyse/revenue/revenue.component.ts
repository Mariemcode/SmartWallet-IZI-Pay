...
export class RevenueComponent implements OnInit {
  ...
  private readonly palette: string[] = [
    '#2e7d32','#1565c0','#6a1b9a','#00838f','#e65100',
    '#4527a0','#ad1457','#558b2f','#00695c','#f9a825',
    '#0277bd','#c62828','#4e342e','#37474f','#6d4c41',
  ...
  load(): void {
    ...
    this.analysisService.getRevenueByCategory(from, to).subscribe({
      next: (data) => {
  ...
  goToSubCategory(cat: CategoryBreakdown): void {
    this.router.navigate(['/layout/analyse/souscat'], {
      queryParams: {
        ...
        type:     'revenue',          // ← différent de dépense
        from:     this.fromDate || '',
        to:       this.toDate   || '',
      }
    });
